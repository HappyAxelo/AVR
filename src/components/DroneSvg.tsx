    ...
    >
      <defs>
        <linearGradient id="droneBody" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#1d3a2d" />
          <stop offset="1" stopColor="#0e2118" />
        </linearGradient>
      </defs>
      ...
      {[52, 268].map((cx) => (
        <g key={cx}>
          ...
          {/* mast */}
          <rect x={cx - 2.5} y={36} width={5} height={16} rx={2} fill="#163024" />
        </g>
      ))}

      {/* arms */}
      <path d="M52 52 L136 72 L184 72 L268 52" fill="none" stroke="#163024" strokeWidth={9} strokeLinecap="round" />
      ...
      {/* tank */}
      <rect x={134} y={86} width={52} height={24} rx={9} fill="#0e2118" stroke="#1d3a2d" strokeWidth={2} />

      {/* spray boom */}
      <path d="M96 112 L224 112" stroke="#163024" strokeWidth={5} strokeLinecap="round" />
      <path d="M160 110 L160 100" stroke="#163024" strokeWidth={4} />
      {/* nozzles */}
      {[104, 160, 216].map((x) => (
